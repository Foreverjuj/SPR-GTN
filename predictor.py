...
p.add_argument('--esm1b_model', type=str, default='', help='The path of esm-1b model_weight parameter.')
p.add_argument('--only_pdbch', default=False, type=str2bool,
               help='To use model_weight parameters trained only on PDBch training set')
